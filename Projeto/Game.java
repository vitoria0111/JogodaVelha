...
public class Game extends JFrame{
	...
	ImageIcon iconCirculo = new ImageIcon(getClass().getResource("O.jpeg"));
	ImageIcon iconX = new ImageIcon(getClass().getResource("X 1.jpeg"));
	...
	public void configurarTela() {
		...
		pTela.setBackground(Color.BLUE);
